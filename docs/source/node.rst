...
Nodes are either manually constructed in order to create a :py:meth:`~dcos_e2e.cluster.Cluster.from_nodes`, or they are retrieved from an existing :py:class:`~dcos_e2e.cluster.Cluster`.
